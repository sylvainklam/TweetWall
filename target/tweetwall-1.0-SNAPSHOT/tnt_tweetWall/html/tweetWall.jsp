...
<c:if test="${renderContext.editMode}">
	...
	<br><fmt:message key="org.jahia.modules.tweetwall.language"/> : ${currentResource.locale.displayLanguage} 
	<br><fmt:message key="org.jahia.modules.tweetwall.edit.howtolaunch"/></p>
</c:if>
<c:if test="${renderContext.previewMode}">
	<p><fmt:message key="org.jahia.modules.tweetwall.track.intro"/> : <b>${currentNode.properties.track.string}</b>
	<br><fmt:message key="org.jahia.modules.tweetwall.language"/> : ${currentResource.locale.displayLanguage}
	<br><fmt:message key="org.jahia.modules.tweetwall.preview.howtolaunch"/></p>
	<a href="#" onclick="sendCmdServer('${startTWSURL}');"><button type="button" class="btn btn-default"><fmt:message key="org.jahia.modules.tweetwall.preview.button.start"/></button></a>
	<a href="#" onclick="sendCmdServer('${stopTWSURL}');"><button type="button" class="btn btn-default"><fmt:message key="org.jahia.modules.tweetwall.preview.button.stop"/></button></a>
